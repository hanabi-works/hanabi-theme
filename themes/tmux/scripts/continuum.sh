...
# configuration
# @hanabi-continuum-mode default (countdown|time|alert|interval)
# @hanabi-continuum-time-threshold 15

alert_mode="@hanabi-continuum-mode"
time_threshold="@hanabi-continuum-time-threshold"
warn_threshold=360
first_save="@hanabi-continuum-first-save"
