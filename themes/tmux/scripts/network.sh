...
HOSTS=$(get_tmux_option "@hanabi-network-hosts" "google.com github.com example.com")
wifi_label=$(get_tmux_option "@hanabi-network-wifi-label" "")
ethernet_label=$(get_tmux_option "@hanabi-network-ethernet-label" "Ethernet")
...
main()
{
  network="$(get_tmux_option "@hanabi-network-offline-label" "Offline")"
