...
IFS=' ' read -r -a no_untracked_files <<< $(get_tmux_option "@hanabi-git-no-untracked-files" "false")
IFS=' ' read -r -a show_remote_status <<< $(get_tmux_option "@hanabi-git-show-remote-status" "false")
show_repo_name="$(get_tmux_option "@hanabi-git-show-repo-name" "false")"
