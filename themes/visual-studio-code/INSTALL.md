...
1. Create extension folder: `~/.vscode/extensions/okash1n.hanabi-theme-vscode-0.1.3`.
...
2. Install `hanabi-theme-vscode-0.1.3.vsix` using `Extensions: Install from VSIX...`.
